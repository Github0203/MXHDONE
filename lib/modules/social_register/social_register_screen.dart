...
import 'package:socialapp/modules/social_register/social_verify_screen.dart';
      ...
      child: BlocConsumer<SocialRegisterCubit, SocialRegisterStates>(
        listener: (context, state) {
          ...
          if (state is SocialCreateUserSuccessState) {
            ...
            navigateTo(context, SocialVerifyScreen(getEmai: email));
            // navigateTo(context, hihi());
            print('getEmai: ' + email.toString());
            SocialRegisterCubit.get(context).getVerifySuccess(email);
            // });
          }
        },
